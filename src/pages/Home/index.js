  ...
  <>
    ...
    <footer className="row">
      <div className="col presta">
        ...
        {last && (  // Vérifie si la variable last est définie et non nulle
    <EventCard  // Si last est définie, rend le composant EventCard
        data-testid="last-event-card"  // Attribut de test pour identifier le composant dans les tests automatisés
        imageSrc={last?.cover}  // Chemin de l'image de l'événement, obtenu à partir de last?.cover
        imageAlt={last?.description}  // Texte alternatif de l'image, obtenu à partir de last?.description
        title={last?.title}  // Titre de l'événement, obtenu à partir de last?.title
        date={new Date(last?.date)}  // Date de l'événement, convertie en objet Date à partir de last?.date
        small  // Indication pour afficher la carte d'événement avec un style plus petit
        label={last?.type}  // Étiquette ou type de l'événement, obtenu à partir de last?.type
    />
    )}
      </div>
